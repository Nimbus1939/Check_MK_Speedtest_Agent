...
Make sure that the user that executes the CronSpeed.py script has full rights to the .csv file, as it will be deleted and created every time the script runs.<br>
